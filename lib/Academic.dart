...
class Academic extends StatefulWidget {
  ...
  @override
  State<Academic> createState() => _Academic();
}

class _Academic extends State<Academic> {
  @override
            ...
            child: Column(
              ...
              children: <Widget>[
                Padding(
                  ...
                  child: Text("Select type",style: GoogleFonts.getFont('Bungee',textStyle:TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: 25),)),
                ),
        Column(
          children: [
